/*
Как устроено Декартово дерево?

По ключам  - бин. дерево поиска.
Куча по приоритетам.

Наху... Зачем его придумали? Для уменьшения вероятности появления бамбуков (которые делают BST, по сути, бесполезными, если появляются)
Приоритеты можно задать вручную, а можно с помощью великого рандома (как тут и сделано).

Операции Min, Max, Search похожи на BST.
*/

// Код взят у YellowSquared
